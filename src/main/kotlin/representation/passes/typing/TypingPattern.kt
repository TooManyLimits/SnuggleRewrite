 ...
 */
fun checkPattern(pattern: ResolvedPattern, scrutineeType: TypeDef, typeCache: TypeDefCache, currentTypeGenerics: List<TypeDef>, currentMethodGenerics: List<TypeDef>): TypedPattern = when (pattern) {
 ...
 */
fun inferPattern(pattern: ResolvedPattern, typeCache: TypeDefCache, currentTypeGenerics: List<TypeDef>, currentMethodGenerics: List<TypeDef>): TypedPattern = when (pattern) {
    is ResolvedPattern.BindingPattern -> {
